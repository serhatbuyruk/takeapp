{
    ...
    'version': '1.5.19',
    'author': 'Autoronics',
    'summary': 'Tedarikçi System By Autoronics',
    'sequence': 1,
    'description':'This is Tedarikçi API management system software',
    'category':'Tedarikçi',
    ...
    'assets': {
        'web.assets_frontend': [
            ...
            'tedarikci/static/src/js/thunkableWebviewerExtension.js',
        ],
        'web.assets_backend': [
