odoo.define("web_view_leaflet_map.MapRenderer", function (require) {
    ...
    var MapRenderer = AbstractRenderer.extend({
        ...
        init: function (parent, state, params) {
            ...
            this.field_son_konum_zamani = params.arch.attrs.field_son_konum_zamani;
            this.field_marker_icon_image = params.arch.attrs.field_marker_icon_image;
            this.marker_icon_size_x = params.arch.attrs.marker_icon_size_x || 32;
            this.marker_icon_size_y = params.arch.attrs.marker_icon_size_y || 32;
        ...
        _preparePopUpData: function (record) {
            var last_location_time = record.data[this.field_son_konum_zamani];
            // 📌 Eğer değer boşsa, "Bilinmiyor" yazsın
            if (!last_location_time) {
                last_location_time = "Bilinmiyor";
            } else {
                // 📌 Odoo'nun tarih formatlama fonksiyonunu kullan
                last_location_time = field_utils.format.datetime(
                    last_location_time,  // 📌 Datetime alanı
                    {},  // Format seçenekleri (boş bırakılabilir)
                    { timezone: true } // 📌 Kullanıcının zaman dilimine göre formatla
                );
            }
            return (
                ...
                "</b><br/>" +
                " - " +
                "Son Konum Zamanı: " + last_location_time  +
                "</div>"
            );
        },
        ...
        _initDefaultPosition: function () {
            ...
            return this._rpc({
                ...
                //self.default_lat_lng = L.latLng(37.136724,30.614598);
            });
        },
        ...
        _initMap: function () {
            ...
            // this.leaflet_tiles = L.tileLayer('https://tile.thunderforest.com/atlas/{z}/{x}/{y}.png?apikey=aaaa', {
