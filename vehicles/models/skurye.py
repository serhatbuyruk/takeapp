...
class skuryeProfileLines(models.Model):
    ...
    name = fields.Char("Name")
    vehicle_start_date = fields.Datetime(string="Vehicle Başlangıç Zamanı", copy=False)
    vehicle_end_date = fields.Datetime(string="Vehicle Bitiş Zamanı", copy=False)
    ...
    vehicle_paket_sayisi = fields.Integer(string="Vehicle Paket Sayısı", copy=False)
