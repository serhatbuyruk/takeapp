{
    ...
    'version': '1.5.19',
    'author': 'Autoronics',
    'summary': 'Stok Takibi System By Autoronics',
    'sequence': 1,
    'description':'This is Stok Takibi API management system software',
    'category':'Stok Takibi',
    'website':'https://www.autoronics.com',
    'depends':['base','website','malzeme','tedarikci'],
    ...
    'assets': {
        'web.assets_frontend': [
            ...
            'stoktakibi/static/src/js/thunkableWebviewerExtension.js',
        ],
        'web.assets_backend': [
