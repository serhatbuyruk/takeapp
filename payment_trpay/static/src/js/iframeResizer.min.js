...
!function (e) {
    "use strict";
    var n, t = 0, i = !1, o = !1, r = "message".length, a = "[iFrameSizer]", s = a.length, c = null,
        f = e.requestAnimationFrame, u = {max: 1, scroll: 1, bodyScroll: 1, documentElementScroll: 1}, l = {}, d = null,
        m = {
            autoResize: !0,
            bodyBackground: null,
            bodyMargin: null,
    ...
    function k(n, t, i, o) {
        !0 === o && "object" == typeof e.console && console[n](p(t), i)
    }

    function x(n) {
        function t() {
            i("Height"), i("Width"), R(function () {
                O(H), z(P)
            }, H, "init")
        }

        function i(e) {
            var n = Number(l[P]["max" + e]), t = Number(l[P]["min" + e]), i = e.toLowerCase(), o = Number(H[i]);
            y(P, "Checking " + i + " is in range " + t + "-" + n), o < t && (o = t, y(P, "Set " + i + " to min value")), o > n && (o = n, y(P, "Set " + i + " to max value")), H[i] = "" + o
        }
        ...
        function f(n, t) {
            S(function () {
                var i, o;
                T("Send Page Info", "pageInfo:" + (i = document.body.getBoundingClientRect(), o = H.iframe.getBoundingClientRect(), JSON.stringify({
                    ...
                    offsetTop: parseInt(o.top - i.top, 10),
                    offsetLeft: parseInt(o.left - i.left, 10),
        ...
        function u(e) {
            ...
            return M(P), {x: Math.floor(Number(n.left) + Number(c.x)), y: Math.floor(Number(n.top) + Number(c.y))}
        }

        function d(n) {
            var t = n ? u(H.iframe) : {x: 0, y: 0}, i = {x: Number(H.width) + t.x, y: Number(H.height) + t.y};
            y(P, "Reposition requested from iFrame (offset x:" + t.x + " y:" + t.y + ")"), e.top !== e.self ? e.parentIFrame ? e.parentIFrame["scrollTo" + (n ? "Offset" : "")](i.x, i.y) : w(P, "Unable to scroll to requested position, window.parentIFrame not found") : (c = i, m(), y(P, "--"))
        }

        function m() {
            !1 !== p("scrollCallback", c) ? z(P) : E()
        }
        ...
        var b, k, x, W = n.data, H = {}, P = null;
        "[iFrameResizerChild]Ready" === W ? function () {
            for (var e in l) T("iFrame requested init", N(e), document.getElementById(e), e)
        }() : a === ("" + W).substr(0, s) && W.substr(s).split(":")[0] in l ? (x = W.substr(s).split(":"), H = {
            iframe: l[x[0]].iframe,
            id: x[0],
            height: x[1],
            width: x[2],
            ...
            false: 1,
            undefined: 1
        }) && y(P, "Ignoring init message from meta parent page"), !k && function (e) {
            var n = !0;
            return l[e] || (n = !1, w(H.type + " No settings for " + e + ". Message was: " + W)), n
        }(P) && (y(P, "Received: " + W), b = !0, null === H.iframe && (w(P, "IFrame (" + H.id + ") not found"), b = !1), b && function () {
            var e, t = n.origin, i = l[P].checkOrigin;
            if (i && "" + t != "null" && !(i.constructor === Array ? function () {
                var e = 0, n = !1;
                for (y(P, "Checking connection is from allowed list of origins: " + i); e < i.length; e++) if (i[e] === t) {
                    n = !0;
                    break
                }
                return n
            }() : (e = l[P].remoteHost, y(P, "Checking connection is from: " + e), t === e))) throw new Error("Unexpected message received from: " + t + " for " + H.iframe.id + ". Message was: " + n.data + ". This error can be disabled by setting the checkOrigin: false option or by providing of array of trusted domains.");
            return !0
        }() && function () {
            switch (l[P].firstRun && (l[P].firstRun = !1), H.type) {
                case"close":
                    F(H.iframe);
                    break;
                case"message":
                    b = o(6), y(P, "MessageCallback passed: {iframe: " + H.iframe.id + ", message: " + b + "}"), p("messageCallback", {
                        iframe: H.iframe,
                        message: JSON.parse(b)
                    }), y(P, "--");
                    break;
                case"scrollTo":
                    d(!1);
                ...
                case"scrollToOffset":
                    ...
                    break;
                case"pageInfo":
                    f(l[P].iframe, P), function () {
                        function n(n, o) {
                            function r() {
                                l[i] ? f(l[i].iframe, i) : t()
                            }

                            ["scroll", "resize"].forEach(function (t) {
                                y(i, n + t + " listener for sendPageInfo"), o(e, t, r)
                            })
                        }
                        ...
                        var i = P;
                        n("Add ", g), l[i].stopPageInfo = t
                    }();
                    break;
                case"pageInfoStop":
                    l[P] && l[P].stopPageInfo && (l[P].stopPageInfo(), delete l[P].stopPageInfo);
                    break;
                case"inPageLink":
                    n = o(9), r = n.split("#")[1] || "", a = decodeURIComponent(r), (s = document.getElementById(a) || document.getElementsByName(a)[0]) ? (i = u(s), y(P, "Moving to in page link (#" + r + ") at x: " + i.x + " y: " + i.y), c = {
                        x: i.x,
                        y: i.y
                    }, m(), y(P, "--")) : e.top !== e.self ? e.parentIFrame ? e.parentIFrame.moveToAnchor(r) : y(P, "In page link #" + r + " not found and window.parentIFrame not found") : y(P, "In page link #" + r + " not found");
                    break;
                case"reset":
                    C(H);
                    break;
                case"init":
                    t(), p("initCallback", H.iframe), p("resizedCallback", H);
                    break;
                default:
                    t(), p("resizedCallback", H)
            }
            var n, i, r, a, s, b
        }())) : v(P, "Ignored: " + W)
    }
    ...
    function F(e) {
        var n = e.id;
        y(n, "Removing iFrame: " + n), e.parentNode.removeChild(e), I(n, "closedCallback", n), y(n, "--"), delete l[n]
    }

    function M(n) {
        null === c && y(n, "Get page position: " + (c = {
    ...
    function z(n) {
        null !== c && (e.scrollTo(c.x, c.y), y(n, "Set page position: " + c.x + "," + c.y), E())
    }
    ...
    function C(e) {
        y(e.id, "Size reset requested by " + ("init" === e.type ? "host page" : "iFrame")), M(e.id), R(function () {
            O(e), T("reset", "reset", e.iframe, e.id)
        }, e, "reset")
    }

    function O(n) {
        function t(t) {
            o || "0" !== n[t] || (o = !0, y(r, "Hidden iFrame detected, creating visibility listener"), function () {
                function n() {
                    function e(e) {
                        function n(n) {
                            return "0px" === l[e].iframe.style[n]
                        }

                        null !== l[e].iframe.offsetParent && (n("height") || n("width")) && T("Visibility change", "resize", l[e].iframe, e)
                    }
                ...
                function t(e) {
                    y("window", "Mutation observed: " + e[0].target + " " + e[0].type), S(n, 16)
                }

                var i = e.MutationObserver || e.WebKitMutationObserver;
                i && (o = document.querySelector("body"), new i(t).observe(o, {
                    attributes: !0,
                    attributeOldValue: !1,
                    characterData: !0,
        ...
        function i(e) {
            !function (e) {
                n.iframe.style[e] = n[e] + "px", y(n.id, "IFrame (" + r + ") " + e + " set to " + n[e] + "px")
            }(e), t(e)
        }

        var r = n.iframe.id;
        l[r] && (l[r].sizeHeight && i("height"), l[r].sizeWidth && i("width"))
    }

    function R(e, n, t) {
        t !== n.type && f ? (y(n.id, "Requesting animation frame"), f(e)) : e()
    }

    function T(e, n, t, i) {
        var o;
        i = i || t.id, l[i] && (t && "contentWindow" in t && null !== t.contentWindow ? (o = l[i].targetOrigin, y(i, "[" + e + "] Sending msg to iframe[" + i + "] (" + n + ") targetOrigin: " + o), t.contentWindow.postMessage(a + n, o)) : (v(i, "[" + e + "] IFrame(" + i + ") not found"), l[i] && delete l[i]))
    }
    ...
    function W(e, n) {
        var o, r = function (o) {
            var r;
            return o, "" === o && (e.id = (r = n && n.id || m.id + t++, null !== document.getElementById(r) && (r += t++), o = r), i = (n || {}).log, o, y(o, "Added missing iframe ID: " + o + " (" + e.src + ")")), o
        }(e.id);
        r in l && "iFrameResizer" in e || (!function (n) {
            var t;
            n = n || {}, l[r] = {
                firstRun: !0,
                iframe: e,
                ...
                for (var n in m) m.hasOwnProperty(n) && (l[r][n] = e.hasOwnProperty(n) ? e[n] : m[n])
            }(n), l[r].targetOrigin = !0 === l[r].checkOrigin ? "" === (t = l[r].remoteHost) || "file://" === t ? "*" : t : "*"
        }(n), y(r, "IFrame scrolling " + (l[r].scrolling ? "enabled" : "disabled") + " for " + r), e.style.overflow = !1 === l[r].scrolling ? "hidden" : "auto", e.scrolling = !1 === l[r].scrolling ? "no" : "yes", function () {
            function n(n) {
                1 / 0 !== l[r][n] && 0 !== l[r][n] && (e.style[n] = l[r][n] + "px", y(r, "Set " + n + " = " + l[r][n] + "px"))
            }

            function t(e) {
                if (l[r]["min" + e] > l[r]["max" + e]) throw new Error("Value for min" + e + " can not be greater than max" + e)
            }

            t("Height"), t("Width"), n("maxHeight"), n("minHeight"), n("maxWidth"), n("minWidth")
        }(), "number" != typeof l[r].bodyMargin && "0" !== l[r].bodyMargin || (l[r].bodyMarginV1 = l[r].bodyMargin, l[r].bodyMargin = l[r].bodyMargin + "px"), o = N(r), g(e, "load", function () {
            var n, t;
            T("iFrame.onload", o, e), n = l[r].firstRun, t = l[r].heightCalculationMethod in u, !n && t && C({
                iframe: e,
                height: 0,
                width: 0,
                type: "init"
            })
        }), T("init", o, e), Function.prototype.bind && (l[r].iframe.iFrameResizer = {
            close: F.bind(null, l[r].iframe),
            resize: T.bind(null, "Window resize", "resize", l[r].iframe),
            moveToAnchor: function (e) {
                T("Move to anchor", "moveToAnchor:" + e, l[r].iframe, r)
            },
            sendMessage: function (e) {
                T("Send Message", "message:" + (e = JSON.stringify(e)), l[r].iframe, r)
            }
        }))
    }
    ...
    function H(e) {
        y("window", "Trigger event: " + e), S(function () {
            A("Window " + e, "resize")
        }, 16)
    }

    function P() {
        "hidden" !== document.visibilityState && (y("document", "Trigger event: Visiblity change"), S(function () {
    ...
    function A(e, n) {
        function t(e) {
            return "parent" === l[e].resizeFrom && l[e].autoResize && !l[e].firstRun
        }

        for (var i in l) t(i) && T(e, n, document.getElementById(i), i)
    }
    ...
    function L() {
        ...
        return function () {
            ...
            for (n = 0; n < t.length && !f; n += 1) f = e[t[n] + "RequestAnimationFrame"];
            f || y("setup", "RequestAnimationFrame not supported")
        }(), g(e, "message", x), g(e, "resize", function () {
            H("resize")
        }), g(document, "visibilitychange", P), g(document, "-webkit-visibilitychange", P), g(e, "focusin", function () {
            H("focus")
        }), g(e, "focus", function () {
            H("focus")
        }), function (e, i) {
            switch (t = [], typeof i) {
                case"undefined":
                case"string":
                    Array.prototype.forEach.call(document.querySelectorAll(i || "iframe"), n.bind(void 0, e));
                    break;
                case"object":
                    n(e, i);
                    break;
    ...
    e.jQuery && ((n = jQuery).fn ? n.fn.iFrameResize = function (e) {
        return this.filter("iframe").each(function (n, t) {
            W(t, e)
        }).end()
    } : v("", "Unable to bind to jQuery, it is not fully loaded.")), "function" == typeof define && define.amd ? define([], L) : "object" == typeof module && "object" == typeof module.exports ? module.exports = L() : e.iFrameResize = e.iFrameResize || L()
}(window || {});
