{
    ...
    'version': '1.5.19',
    'author': 'Autoronics',
    'summary': 'Malzeme System By Autoronics',
    'sequence': 1,
    'description':'This is Malzeme API management system software',
    'category':'Malzeme',
    'website':'https://www.autoronics.com',
    'depends':['base','website','tedarikci'],
    ...
    'assets': {
        'web.assets_frontend': [
            ...
            'malzeme/static/src/js/thunkableWebviewerExtension.js',
        ],
        'web.assets_backend': [
