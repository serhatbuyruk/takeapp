...
class hbookingsProfile(models.Model):
    _name = "hbookings.profile"
    ...
    users_can_edit = fields.Many2many('res.users',relation='x_hbookings_profile_res_users_rel', column1='hbookings_users_id',column2='res_users_id', string="Users Can Edit")
    card_owner = fields.Many2one('res.partner', string="Card Owner")
    hbookings_image = fields.Binary(string="Image")
    ...
    adult_number = fields.Integer(string="Adult Number")
    child_number = fields.Integer(string="Child Number")
    room_status = fields.Selection([('booked','Booked'),('sold','Sold'),('free','Free'),('canceled','Canceled')],
                                    string="Room Status", default="sold", tracking=True
                                    )
    ...
    #                                 )
    contracts_attachment_ids = fields.Many2many('ir.attachment','attachment_rel_contracts_hbookings','pro_id_contracts_hbookings','attach_id_contracts_hbookings', string='Contracts',) 
    ...
    attachment_ids = fields.Many2many('ir.attachment','attachment_rel_hbookings','pro_id_hbookings','attach_id_hbookings', string='Attachments',) 
    ...
    def from_profile(self):
        ...
        #         'type': 'ir.actions.act_url',
        #         'target' : 'self',
        #         'url': ("/web/#id=" + str(119) + "&menu_id=284&action=390&model=hbookings.profile&view_type=form/")
        #        }
