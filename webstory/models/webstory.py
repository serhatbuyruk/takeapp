...
class webstoryProfile(models.Model):
    _name = "webstory.profile"

    name = fields.Char(string="Name")
    sequence = fields.Integer(string="Sequence", default=1)
    visibility = fields.Boolean(string="Visibility", default=True)
    image_type = fields.Selection([('webstory','webstory'),('service','Service'),('notification','Notification')],
                                    string="Image Type ", default="webstory"
                                    )
    title = fields.Char(string="Title")
    description = fields.Char(string="Description")
    webstory_image_small = fields.Binary(string="Image 158*220")
    webstory_image_big = fields.Binary(string="Image 503*700")
    ...
    #     }
        ...
        #         'type': 'ir.actions.act_url',
        #         'target' : 'self',
        #         'url': ("/web/#id=" + str(119) + "&menu_id=284&action=390&model=webstory.profile&view_type=form/")
        #        }
